...
- fx/Resize.py/CLASSES/Resize/METHODS/apply (Method) -> fx/Resize.py/CLASSES/Resize (Class)

## Call edges

- fx/Resize.py/CLASSES/Resize/METHODS/apply (Method) -> VideoClip.py/CLASSES/ImageClip/METHODS/transform (Method)
